    ...
    <div class="p-5">
      <div class="card px-2 pt-3 pb-1">
        <div class="row gx-3 flex-wrap">
          <div class="col-12">
            <div class="" id="conge">
      <div v-if="changeConge" class="">
        <div class="content">
          <div class="header">
            <h5 class="title" id="staticBackdropLabel"> Programmer un congé </h5>
          ...
          <div class="body">
            ...
            <Form @submit="sendCongeDemande" :validation-schema="schemaCongeDemande()">
              ...
              <select v-model="personnelCongeDemande.conge.type" name="congeId" id="congeTypeId" class="form-select mb-1">
                ...
                <option :value="typeConge.id" v-for="typeConge in $store.state.typeConges" :key="typeConge.id"> {{
