...
<div class="modal fade" id="AddServiceModal" tabindex="-1" role="dialog" ref="addServiceModalRef" aria-labelledby="tooltipmodal" aria-hidden="true">
...
export default {
  ...
  setup: (props, { emit }) => {
    ...
    return { serviceSchema, addService, serviceForm,addServicesModalRef,btntext,title,resetValue };
  },
};
