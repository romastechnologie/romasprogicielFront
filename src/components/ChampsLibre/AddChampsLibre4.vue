                      ...
                      <div class="row" v-for="(enfant, index) in enfants" :key="index">
                        <div class="col-md-3 mb-3">
                          <div class="form-group mb-5 mb-sm-5 mb-md-5">
                            ...
                            <div class="invalid-feedback" v-if="valideteRowValeurPossible(enfant.valeur)">
                        ...
                        <div class="col-md-3 mb-3">
                          <div class="form-group mb-5 mb-sm-5 mb-md-5">
                            <input v-model="enfant.libelle" type="text"
                              class="form-control shadow-none fs-md-15 text-black" placeholder="saisir le libelle" />
                            <div class="invalid-feedback" v-if="valideteRowValeurPossible(enfant.libelle)">
            ...
            <div class="col-md-12">
              <div class="d-flex align-items-center ">
                <button
                  ...
                  type="submit"
                >
                  Créer un champs libre
                </button>
                <router-link to="/champsLibres/liste-champsLibre" 
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const getAllTypeChampsLibre = async () => {
        try{
        const response = await ApiService.get('/typechampsLibres');
        const typeChampsLibresData = response.data.data.data;
