        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-check mt-3 mb-2 mb-sm-2 mb-md-2">
              ...
              <input id="estObligatoire" name="estObligatoire" v-model="estObligatoire" :value="estObligatoire"
          ...
          <div class="col-md-4 mb-3">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="libelleChamp" type="text" class="form-control shadow-none fs-md-15 text-black"
          ...
          <div class="col-md-4 mb-3">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="nomChamp" type="text" class="form-control shadow-none fs-md-15 text-black"
                placeholder="Entrer le nom du champ" />
          ...
          <div class="col-md-4 mb-3">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="valeurParDefaut" type="text" class="form-control shadow-none fs-md-15 text-black"
          ...
          <div class="col-md-4 mb-3">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="typeChampsLibre" v-model="typeChampsLibre" type="text" v-slot="{ field }">
                <Multiselect v-model="field.value" v-bind="field" :options="typeChampsLibreOptions"
                  :preserve-search="true" :multiple="false" :searchable="true"
                  placeholder="Sélectionner le type de champ libre" label="label" track-by="label" />
              </Field>
            ...
            <div class="row" v-for="(valeurPossible, index) in valeurPossibles" :key="index">
              <div class="col-md-5 mb-3">
                <div class="d-block text-black fw-semibold mb-10">
                  <input v-model="valeurPossible.valeur" type="text"
                    class="form-control shadow-none fs-md-15 text-black" placeholder="Saisir la valeur" />
