<template>
    <div class="col-xxl-3 col-xl-4 box-col-4e sidebar-left-wrapper">
        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
            <li class="nav-item" v-for="(item, index) in add" :key="index"> <a class="nav-link " v-bind:class="{ 'active': item.title === activeclass }" id="detail-product-tab" data-bs-toggle="pill"
