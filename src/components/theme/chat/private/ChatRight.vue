        ...
        <div class="card right-sidebar-chat">
            <div class="right-sidebar-title">
                <div class="common-space">
                    <div class="chat-time">
                        <div class="active-profile"><img class="img-fluid rounded-circle" v-if="currentChat.img"
                                :src="getImages(currentChat.img)" alt="user">
                            <div class="status " :class="currentChat.bgclass"></div>
                        </div>
            ...
            <div class="right-sidebar-Chats">
                <div class="msger">
                    <div class="msger-chat">
                        <div class="msg " v-for="(chat, index) in currentChat.messages" :key="index" v-bind:class="[{ clearfix: chat.sender == 0 }, {
