    ...
    <div class="col-xl-8 xl-50 col-md-7">
        <div class="tab-content" id="v-pills-tabContent" :style="filter ? 'display: none;' : ''">
            <div class="tab-pane contact-tab-0 tab-content-child fade " :class="contact.active ? 'active show' : ''"
                ...
                v-for="(contact, index) in personal" :key="index">
                    ...
                    <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_0"
                        ...
                        <div class="flex-grow-1 mt-0">
                            ...
                            <ul>
                                ...
                                <li><a href="javascript:void(0)" v-on:click="basic_warning_alert(index)">Delete</a></li>
...
function basic_warning_alert(index: number) {
    Swal.fire({
        ...
        showCancelButton: true, cancelButtonText: 'Cancel', confirmButtonText: 'Ok', confirmButtonColor: 'var(--theme-deafult)',
    }).then((result) => {
        if (result.value) {
