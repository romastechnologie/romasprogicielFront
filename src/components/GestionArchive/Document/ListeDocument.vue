          ...
          <table class="table text-nowrap align-middle mb-0">
            <thead>
              <tr>
                ...
                <th scope="col" class="text-uppercase fw-medium shadow-none text-body-tertiary fs-13 pt-0">Date fin conservation</th>
                ...
                <td class="shadow-none lh-1 fw-medium text-body-tertiary text-end pe-0">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown-item d-flex align-items-center">
                        <a href="javascript:void(0);" @click="suppression(document.id, documents, 'documents', `le document ${document.nom}`)">
