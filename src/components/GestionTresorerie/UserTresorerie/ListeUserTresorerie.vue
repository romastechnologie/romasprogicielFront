<template>
      ...
      >
        <div class="d-sm-flex align-items-center">
          <a 
            ...
            data-bs-target="#AddUserTresorerieModal"
          >
          ...
          <table class="table text-nowrap align-middle mb-0">
            ...
            <tbody>
              <tr v-for="(usertresorerie, index) in usertresoreries" :key="index">
                ...
                <td class="shadow-none lh-1 fw-medium text-black-emphasis">
                  {{ format_date(usertresorerie.createdAt)  }}
                </td>
                <td
    ...
    <AddUserTresorerieModal
      @get-all-usertresoreries="getAllUserTresoreries"
      :id="idusertresorerie"
      @openmodal="showModalEdite"
      @close="recharger"
      @refreshUserTresoreries="refreshUserTresoreries"
    />
  </template>
  <script lang="ts">
  import { defineComponent, onMounted, ref  } from "vue";
  import AddUserTresorerieModal from "./AddUserTresorerieModal.vue";
  ...
  export default defineComponent({
    ...
    setup: () => {
      ...
      const handlePaginate = ({ page_, limit_ }: { page_: number, limit_: number }) => {
        try {
          page.value = page_;
          getAllUserTresoreries(page_, limit_);
        } catch (error) {
          //
        }
      };
      ...
      function getAllUserTresoreries(page = 1, limi = 10, searchTerm = '') {
        return ApiService.get(`/userTresoreries?page=${page}&limit=${limi}&mot=${searchTerm}&`)
          .then(({ data }) => {
            console.log("Valeurs recupérées",data)
            usertresoreries.value = data.data.data;
