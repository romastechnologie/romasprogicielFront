    ...
    <div class="card-body p-15 p-sm-20 p-md-25 p-lg-30 letter-spacing">
      <Form class="row g-3" :validation-schema="schema" @submit="sendFinance">
        <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <Field
              ...
              name="modepaiement"
              class="form-select"
              v-model="finance.modepaiement"
              v-slot="{ field }"
            >
              <Multiselect
                v-model="field.value"
                v-bind="field"
                :options="['Espece', 'Momo', 'Chèque', 'Virement bancaire']"
          ...
          <div class="mb-3">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              <label class="d-block text-black mb-10">
                Dépense <span class="text-danger">*</span>
              </label>
          ...
          <div
            class="mb-3"
            v-if="depenseSelected && beneficiaireselect && beneficiaireselect !== ''"
          >
          ...
          <div
            class="mb-3"
            v-if="depenseSelected && selectedPersonnel && selectedPersonnel.value"
          >
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              <label class="d-block text-black mb-10">
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3">
            <button type="submit" class="btn btn-primary">Ajouter un financement</button>
            <router-link
              to="/finances/liste-finance/"
              type="button"
...
const resteAPayer = ref(null);
const depenseId = ref(null);
...
try {
  const payload = {
    ...
    personnelName: personnelSelect.value,
    beneficiaire: beneficiaireselect.value,
  };
  ...
  if (data.code === 201) {
    ...
    // Si le reste à payer est 0, retirer la dépense de la liste
    if (resteAPayer.value === 0 && depenseId.value) {
      depenseOptions.value = depenseOptions.value.filter(
        (depense) => depense.value !== depenseId.value
      );
      depenseId.value = null;
      depenseSelected.value = false;
      montantTotalDepense.value = 0;
      resteAPayer.value = null;
      beneficiaireselect.value = null;
      selectedPersonnel.value = null;
      personnelSelect.value = null;
    }
...
try {
  ...
  depenseOptions.value = depensesData
    .filter((depense) => depense.reste_a_payer > 0) // Filtrer les dépenses non entièrement financées
    .map((depense) => ({
      value: depense.id,
