<template>
      ...
      >
        <div class="d-sm-flex align-items-center">
          <a 
            ...
            data-bs-target="#AddUserCompteModal"
          >
          ...
          <table class="table text-nowrap align-middle mb-0">
            <thead>
              <tr>
                <th
                  scope="col"
                  class="text-uppercase fw-medium shadow-none text-body-tertiary fs-13 pt-0">Numéro de compte
                </th>
                <th
                  scope="col"
                ...
                <th
                  scope="col"
                  class="text-uppercase fw-medium shadow-none text-body-tertiary fs-13 pt-0">Trésorerie
                </th>
                <th
                  scope="col"
            ...
            <tbody>
              <tr v-for="(usercompte, index) in usercomptes" :key="index">
                ...
                <td class="shadow-none lh-1 fw-medium text-black-emphasis">
                  {{ format_date(usercompte.createdAt)  }}
                </td>
                <td
    ...
    <AddUserCompteModal
      @get-all-usercomptes="getAllUserComptes"
      :id="idusercompte"
      @openmodal="showModalEdite"
      @close="recharger"
      @refreshUserComptes="refreshUserComptes"
    />
  </template>
  <script lang="ts">
  ...
  export default defineComponent({
    ...
    setup: () => {
      ...
      function moddifier(Editusercompte:UserCompte) {
        idusercompte.value = Editusercompte.id;
      }
      ...
      const checkUserCompte = (name:string) => {
