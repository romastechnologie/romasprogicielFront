    ...
    <div class="card mb-25 border-0 rounded-0 bg-white add-user-card">
      <div class="card-body p-15 p-sm-20 p-md-25 p-lg-30 letter-spacing">
        ...
        >
          <div class="row">
            ...
            <div class="col-6 d-flex align-items-center my-3">
              <div class="form-check me-3">
                ...
                <label class="form-check-label" for="nonOperationnelle">Non Opérationnelle</label>
              </div>
              <div class="form-check">
                ...
                <label class="form-check-label" for="operationnelle">Opérationnelle</label>
              </div>
            </div>
          ...
          <div class="row">
            <!-- Type de trésorerie et Date de création -->
            <div class="col-6 my-3">
