<template>
  <div class="card mb-25 border-0 rounded-0 bg-white add-user-card">
    <div class="card-header">
      <h3 class="text-black fw-semibold">Faire un transfert</h3>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="tresorerie" v-slot="{ field }">
                <Multiselect :options="tresorerieOptions" :searchable="true" track-by="value" label="label"
          ...
          <div class="col-md-6">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="tresorerie2" v-slot="{ field }">
                <Multiselect :options="tresorerieOptions2" :searchable="true" track-by="value" label="label"
          ...
          <div class="col-md-6">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="montant" type="number" class="form-control shadow-none fs-md-15 text-black"
          ...
          <div class="col-md-6">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="dateDeTransfert" class="form-control shadow-none fs-md-15 text-black" type="datetime-local" :max="currentDateTime"
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const dateDeTransfert = ref(getCurrentDateTime());
    ...
    const fetchTresorerie = async () => {
      try {
        ...
        tresorerieOptions.value = response.data.data.data
          .filter(tresorerie => tresorerie.operation === true) // Filtrer les trésoreries avec operation = "Oui"
          .map(tresorerie => ({
            value: tresorerie.id,
            label: tresorerie.nom,
          }));
      } catch (err) {
        error("Erreur lors de la récupération des trésoreries.");
      }
    };
    ...
    const fetchTresorerie2 = async () => {
      try {
        const response = await axios.get('all/tresoreries');
        tresorerieOptions2.value = response.data.data.data
          .filter(tresorerie => tresorerie.operation === true) // Filtrer les trésoreries avec operation = "Oui"
          .map(tresorerie2 => ({
