  ...
  <div class="card mb-25 border-0 rounded-0 bg-white add-user-card">
    <div class="card-body p-15 p-sm-20 p-md-25 p-lg-30 letter-spacing">
      <Form
        ref="horaireForm"
        @submit="addHoraire"
        :validation-schema="horaireSchema"
      >
        <div class="row">
          ...
          <div class="col-md-2">
            <label for="heureOuverture" class="form-label"
              >Heure D'ouverture<span class="text-danger">*</span></label
            >
          ...
          <div class="col-md-2">
            <label for="heureFermeture" class="form-label">
              Heure de Fermeture<span class="text-danger">*</span></label
            >
            <Field name="heureFermeture" class="form-control" type="time" />
            <ErrorMessage name="heureFermeture" class="text-danger" />
          </div>
          <div class="col-md-2">
            <label for="heureDebutPause" class="form-label">
              Heure début de pause<span class="text-danger">*</span></label
            >
            <Field name="heureDebutPause" class="form-control" type="time" />
            <ErrorMessage name="heureDebutPause" class="text-danger" />
          </div>
          <div class="col-md-2">
            <label for="heureFinPause" class="form-label">
              Heure de fin de pause<span class="text-danger">*</span></label
            >
          ...
          <div class="col-md-12 mt-3">
            <div class="d-flex align-items-center">
              ...
              <router-link to="/horaires/liste-horaire" class="btn btn-danger"
...
export default defineComponent({
  ...
  setup: () => {
    const horaireSchema = Yup.object().shape({
      ...
      heureOuverture: Yup.string().required(
        "L'heure d'ouverture est obligatoire."
      ),
      heureFermeture: Yup.string().required(
        "L'heure de fermeture est obligatoire."
      ),
      heureDebutPause: Yup.string().required(
