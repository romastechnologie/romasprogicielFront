                   ...
                   <button class="btn dropdown-toggle btn-primary" type="button" data-bs-toggle="dropdown" aria-expanded="false">Actions</button>
                     <ul class="dropdown-menu">
                       ...
                       <li >
                         <a
                           class="dropdown-item d-flex align-items-center"
                           href="javascript:void(0);" @click="suppression(conge.id,conges,'conges','conge')"
                         >
                           <i
  ...
  import JwtService from "@/services/JwtService";
   ...
   export default defineComponent({
     ...
     setup: () => {
       ...
       function rechercher(){
         getAllConge(page.value, limit.value, searchTerm.value );
       }
   
       // END PAGINATE
   
       function getAllConge(page = 1, limi = 10, searchTerm = '') {
         return ApiService.get(`conges?page=${page}&limit=${limi}&mot=${searchTerm}&`)
         .then(({ data }) => {
          console.log(data); 
       ...
       function moddifier(EditConge:Conge) {
         conge.value = EditConge;
         selectedItem.value = EditConge.id;
       }
       const recharger = () => {
         getAllConge();
       };
