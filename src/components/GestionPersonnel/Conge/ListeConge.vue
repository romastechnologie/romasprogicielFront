        ...
        <table class="table m-0">
          ...
          <tbody>
            <tr v-for="personnelConge in filterConge" :key="personnelConge.personnel">
              ...
              <td v-if="personnelConge.statut === 'Confirmé'" class="text-center"> Confirmé </td>
              <td v-else-if="personnelConge.statut === 'Annulé'" class="text-center"> Annulé </td>
              <td v-else-if="personnelConge.statut === 'Interrompu'" class="text-center"> Interrompu </td>
              <td v-else-if="personnelConge.statut === 'Terminé'" class="text-center"> Terminé </td>
              <td>
                <div class="d-flex justify-content-center">
