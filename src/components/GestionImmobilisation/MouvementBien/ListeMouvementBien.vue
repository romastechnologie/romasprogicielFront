    ...
    <div class="card mb-25 border-0 rounded-0 bg-white letter-spacing">
      ...
      <div class="card-body p-15 p-sm-20 p-md-25">
        <div class="table-responsive">
          <table v-if="mouvementBiens.length > 0" class="table text-nowrap align-middle mb-0">
            <thead>
              <tr>
                <th
                  scope="col"
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li>
                            <router-link
                              ...
                              :to="{ name: 'EditMouvementBienPage',params: { id: mouvementBien.id } }"
                            >
    ...
    setup(){
      ...
      function getAllBiens(page = 1, limi = 10, searchTerm = '') {
        return ApiService.get(`/all/mouvementBiens?page=${page}&limit=${limi}&mot=${searchTerm}&`)
          .then(({ data }) => {
            mouvementBiens.value = data.data;
