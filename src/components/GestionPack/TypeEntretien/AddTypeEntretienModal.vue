            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="description" cols="12" rows="6" as="textarea" placeholder="Description" v-slot="{ field }"
                              ...
                              <div class="border border-primary mb-10">
                                ...
                                <div>
                                  <div class="row d-flex align-items-center justify-content-between mt-10">
                                    ...
                                    <div class="col-md-2">
                                      <label class="d-block text-black fw-semibold mb-10">
                                        Caburation /km<span class="text-danger">*</span>
                                      </label>
                                    </div>
                                    <div class="col-md-2">
                                      <label class="d-block text-black fw-semibold mb-10">
                                  ...
                                  <div class="row" v-for="(fonction, index) in fonctions" :key="index">
                                    ...
                                    <div class="col-md-2 mb-2">
                                      <div class="form-group mb-5 mb-sm-5 mb-md-5">
                                        <input v-model="fonction.caburation" type="text"
                                          class="form-control shadow-none fs-md-15 text-black"
                                          placeholder="indiquer la caburation" />
                                      </div>
                                      <div class="invalid-feedback" v-if="valideteRowFonction(fonction.caburation)">
                                        La caburation est obligatoire.
                                      </div>
                                    </div>
                                    <div class="col-md-2 mb-2">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const valideteRowFonction = (e) => {
      if (e == "" || e == 0 || e == "0" || e == null || e == null || e < 0) {
        console.log('erg')
        return true;
      } else {
        return false;
