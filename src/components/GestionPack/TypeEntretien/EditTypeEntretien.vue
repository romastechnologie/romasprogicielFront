<template>
    <div class="card mb-25 border-0 rounded-0 bg-white add-user-card">
      <div class="card-body p-15 p-sm-20 p-md-25 p-lg-30 letter-spacing">
            <Form ref="typeEntretienForm" @submit="editTypeEntretien" :validation-schema="typeEntretienSchema">
              <div class="row">
...
import { title } from '@/composables/createProject';
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const editTypeEntretienRef = ref<null | HTMLElement>(null);
          ...
          ApiService.put("/typeEntretiens" + values.id, values)
            .then(({ data }) => {
              if (data.code == 200) {
                ...
                //hide(editTypeEntretienRef.value);
