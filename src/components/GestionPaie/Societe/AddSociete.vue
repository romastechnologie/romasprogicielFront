           ...
           <div class="col-md-4 mb-3">
            ...
            <div class="col-md-12 mt-3">
              <div class="d-flex align-items-center ">
                ...
                <router-link to="/societes/liste-societes" class=" btn btn-danger "><i
  ...
  if (phoneObject.valid) {
    ...
    telephoneRep.value = "";
      ...
      const addSociete = async (values, {resetForm}) => {
        console.log("valeur de la société",values);
        ApiService.post("/societes0",values)
          .then(({ data }) => {
            if(data.code == 201) { 
