<template>
    ...
    >
      <div class="d-sm-flex align-items-center">
        <a 
          ...
          data-bs-target="#AddCategoriesDepensesModal"
        >
        ...
        <table class="table text-nowrap align-middle mb-0">
          <thead>
            <tr>
              <th
                scope="col"
                class="text-uppercase fw-medium shadow-none text-body-tertiary fs-13 pt-0">Reférence
              </th>
              <th
                scope="col"
              ...
              <ul class="dropdown-menu dropdown-block" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(267px, 305px);" data-popper-placement="bottom-start">
                ...
                <li class="dropdown-item d-flex align-items-center">
                  <a href="javascript:void(0);"
                      @click="suppression(categorieDepenses.id,categoriesDepenses,'categoriesDepenses',`la categorieDepenses ${categorieDepenses.libelle}`)">  <i class="fa fa-trash-o lh-2 me-8 position-relative top-1"></i>
                       Supprimer
                  </a>
                </li>
              </ul>
  ...
  <AddCategoriesDepensesModal
    @get-all-categorieDepensess="getAllCategoriesDepenses"
    :id="idCategoriesDepenses"
    @openmodal="showModalEdite"
    @close="recharger"
    @refreshCategoriesDepensess="refreshCategoriesDepenses"
  />
</template>
<script lang="ts">
