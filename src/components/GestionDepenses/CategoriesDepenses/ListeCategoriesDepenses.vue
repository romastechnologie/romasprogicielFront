<template>
  <div class="card mb-25 border-0 rounded-0 bg-white letter-spacing">
    <div
      ...
      <div class="d-sm-flex align-items-center">
        <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#AddCategoriesDepensesModal">
          <i class="fa fa-plus-circle"></i>
          <!-- <i class="fa fa-plus-circle"></i> -->
          Ajouter une Categorie Depense
        </a>
        <!-- <button
      ...
      <div class="d-flex align-items-center">
        <form class="search-box position-relative me-15" @submit.prevent="rechercher">
          <input type="text" v-model="searchTerm" @keyup="rechercher"
            class="form-control shadow-none text-black rounded-0 border-0" placeholder="Rechercher un privilege" />
    ...
    <div class="card-body p-15 p-sm-20 p-md-25">
      <div class="table-responsive">
        <table class="table text-nowrap align-middle mb-0">
          <thead>
            <tr>
              <th scope="col" class="text-uppercase fw-medium shadow-none text-body-tertiary fs-13 pt-0">Reférence
              </th>
              <th scope="col" class="text-uppercase fw-medium shadow-none text-body-tertiary fs-13 pt-0">Libelle
              </th>
              ...
              <td class="shadow-none lh-1 fw-medium text-black pe-0">
                ...
                <ul class="dropdown-menu dropdown-block"
                  ...
                  <li class="dropdown-item d-flex align-items-center">
                    <a href="javascript:void(0);" @click="moddifier(categorieDepenses)">
                      <i class="fa fa-pencil lh-2 me-8 position-relative top-1"></i> Modifier
                    </a>
                  </li>
                  <li class="dropdown-item d-flex align-items-center">
                    <a href="javascript:void(0);"
                      @click="suppression(categorieDepenses.id, categoriesDepenses, 'categoriesDepenses', `la categorieDepenses ${categorieDepenses.libelle}`)">
  ...
  <AddCategoriesDepensesModal @get-all-categorieDepensess="getAllCategoriesDepenses" :id="idCategoriesDepenses"
    @openmodal="showModalEdite" @close="recharger" @refreshCategoriesDepensess="refreshCategoriesDepenses" />
</template>
<script lang="ts">
import { defineComponent, onMounted, ref  } from "vue";
import AddCategoriesDepensesModal from "./AddCategoriesDepensesModal.vue";
...
export default defineComponent({
  name: "ListeCategoriesDepenses",
  components: {
    AddCategoriesDepensesModal,
    PaginationComponent
  },
  setup: () => {
    ...
    const categoriesDepenses = ref<Array<CategoriesDepenses>>([]);
    const idCategoriesDepenses = ref(0);
    ...
    function rechercher() {
      getAllCategoriesDepenses(page.value, limit.value, searchTerm.value);
    }
    ...
    const refreshCategoriesDepenses = () => {
      getAllCategoriesDepenses();
    };
    ...
    function showModalEdite(model: any) {
      showModal(model);
      idCategoriesDepenses.value = 0;
    }

    const privileges = ref<Array<string>>(JwtService.getPrivilege());

    const checkCategoriesDepenses = (name:string) => {
      return privileges.value.includes(name);
    }

    return {
      suppression,
      checkCategoriesDepenses,
      categoriesDepenses,
      format_date,
      getAllCategoriesDepenses,
      idCategoriesDepenses,
      moddifier,
      showModalEdite,
      page,
      totalPages,
