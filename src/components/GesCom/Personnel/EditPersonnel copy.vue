            ...
            <div class="row g-2">
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="dateNais" v-model="dateNaissance" type="date"
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="numeroSecuriteSociale" v-model="numSecSocial" type="text"
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <ErrorMessage name="religions" class="text-danger" />
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <ErrorMessage name="ethnies" class="text-danger" />
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="services" v-model="service" type="text" v-slot="{ field }">
                    <Multiselect v-model="field.value" v-bind="field" :options="serviceOptions" :preserve-search="true"
                      :multiple="false" :searchable="true" placeholder="Sélectionner le service" label="label"
                      track-by="label" />
                  </Field>
                  <ErrorMessage name="services" class="text-danger" />
                </div>
              </div>
            ...
            <div class="row g-2">
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="telephone1" v-model="telephone1" type="text"
                    class="form-control shadow-none fs-md-15 text-black" placeholder="Entrer le téléphone" />
                  <ErrorMessage name="telephone1" class="text-danger" />
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="telephone2" v-model="telephone2" type="text"
                    class="form-control shadow-none fs-md-15 text-black" placeholder="Entrer le téléphone" />
                  <ErrorMessage name="telephone2" class="text-danger" />
                </div>
              </div>
            ...
            <div class="row g-2">
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="prenomCon" v-model="prenomCon" type="text"
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="dateNaissanceCon" v-model="dateNaissanceCon" type="date"
                    class="form-control shadow-none fs-md-15 text-black"
                    placeholder="Entrer la date de naissance du conjoint " />
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="nationaliteCon" v-model="nationaliteCon" type="text"
                    class="form-control shadow-none fs-md-15 text-black"
                    placeholder="Entrer la nationalité du conjoint " />
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="telephoneCon" v-model="telephoneCon" type="string"
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Field name="passportCon" v-model="numPassportCon" type="text"
                    class="form-control shadow-none fs-md-15 text-black"
                    placeholder="Entrer la nationalité du conjoint " />
                  <ErrorMessage name="passportCon" class="text-danger" />
                </div>
            ...
            <div class="row g-2">
              ...
              <div class="col-md-4 mb-3">
                <div class="form-group mb-15 mb-sm-20 mb-md-25">
                  ...
                  <Multiselect :options="banqueOptions" :searchable="true" track-by="label" label="label"
                    placeholder="Sélectionner la banque" />
                </div>
              </div>
              <h1>Informations sur la personne à contacter</h1>
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const editPersonnel = async (values, {resetForm}) => {
      const data = personnelForm.value;
      ...
      ApiService.put("/personnels/" + data?.id, data)
        .then(({ data }) => {
          if (data.code == 200) {
            success(data.message);
            resetForm();
    ...
    return { 
      personnelSchema, editPersonnel, personnelForm,
        removeRowFonction,
        addRowFonction,
        valideteRowFonction,
        valuess,
