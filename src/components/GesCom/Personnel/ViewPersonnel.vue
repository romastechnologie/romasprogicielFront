<template>
  ...
  <div class="w-100 d-flex justify-content-end">
    <router-link 
      ...
      :to="{ name: 'EditPersonnellePage2', params: { id: personnel.id } }" 
      class="btn btn-primary transition border-0 lh-1 fw-medium">
      <i class="fas fa-arrow-left lh-1 me-1 position-relative top-2"></i>
      Modifier
    </router-link>
  </div>
</div>
  ...
  <i :class="isOpen ? 'fas fa-chevron-down' : 'fas fa-chevron-up'"></i> Voir plus
        ...
        <ul class="nav nav-tabs border-tab nav-primary mb-3" id="top-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="family-info-tab" data-bs-toggle="tab" href="#enfant-info" role="tab" aria-controls="family-info" aria-selected="false">
        ...
        <div class="tab-content" id="top-tabContent">
          <div class="tab-pane fade show active" id="contact-info" role="tabpanel" aria-labelledby="contact-info-tab">    
            ...
            <div class="mt-3">
            <button class=" btn btn-success"  @click="openModal('contact')"> <i class="fa fa-edit lh-1 me-1 position-relative top-2"></i>
                  <span class="position-relative">Modifier</span></button>
                </div>
          </div>
            ...
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  <td> {{ personnel?.conjoints?.dateNaissanceCon || 'Non renseigné' }}</td>
                ...
                <tr>
                  ...
                  <td>{{ personnel?.conjoints?.telephoneCon || 'Non renseigné' }}</td>
                </tr>
              </tbody>
            </table>
            <div class="mt-3">
            <button class=" btn btn-success" data-bs-target="#create-task"  @click="openModal('family')"> <i class="fa fa-edit lh-1 me-1 position-relative top-2"></i>
              <span class="position-relative">Modifier</span></button>
              </div>

          </div>

          <div class="tab-pane fade" id="enfant-info" role="tabpanel" aria-labelledby="enfant-info-tab">
  ...
  <div class="mt-3">
    <button class="btn btn-success" data-bs-target="#create-task" @click="openModal('enfant')">
      ...
      <span class="position-relative">Modifier</span>
          ...
          <div class="tab-pane fade" id="health-info" role="tabpanel" aria-labelledby="health-info-tab"> 
            ...
            <div class="mt-3">
              <button class=" btn btn-success " data-bs-target="#create-task"   @click="openModal('health')"> <i class="fa fa-edit lh-1 me-1 position-relative top-2"></i>
                <span class="position-relative">Modifier</span></button>
            </div>
          </div>
          <div class="tab-pane fade" id="bank-info" role="tabpanel" aria-labelledby="bank-info-tab">     
            ...
            <div class="mt-3">
              <button class=" btn btn-success " data-bs-target="#create-task"   @click="openModal('bank')"> <i class="fa fa-edit lh-1 me-1 position-relative top-2"></i>
                  <span class="position-relative">Modifier</span></button>
            </div>
          </div>
        </div> 
    ...
    <div v-if="isModalOpen" class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
        ...
        <template v-if="modalType === 'contact'">
          <form @submit.prevent="saveContactInfo">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" v-model="personnel.nomPersonneAContacter">
            </div>
            <div class="mb-3">
              <label class="form-label">Prénom personne à contacter</label>
              <input type="text" class="form-control" v-model="personnel.prenomPersonneAContacter">
            </div>
            <div class="mb-3">
              <label class="form-label">Téléphone</label>
              <input type="text" class="form-control" v-model="personnel.telephonePersonneAContacter">
            </div>
            <div class="mb-3">
              <label class="form-label">Relation</label>
              <input type="text" class="form-control" v-model="personnel.relation">
            </div>
        ...
        <template v-if="modalType === 'family'">
          <form @submit.prevent="saveFamilyInfo">
            ...
            <div class="row mb-2">
              ...
              <input type="text" class="form-control" v-model="personnel.conjoints.nomCon">
            </div>
              <div class="col-md-6">
              <label class="form-label">Prénom conjoint</label>
              <input type="text" class="form-control" v-model="personnel.conjoints.prenomCon">
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-6">
              <label class="form-label">Date de naissance</label>
              <input type="date" class="form-control" v-model="personnel.conjoints.dateNaissanceCon">
            </div>
            <div class="col-md-6">
          ...
          <div class="row mb-2">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" v-model="personnel.conjoints.numPassportCon">
            </div>
            <div class="col-md-6">
              <label class="form-label">Religion conjoint</label>
              <Field
                                    name="religionCon"
                                    v-model="personnel.conjoints.religionCon"
                                    type="text"
                                    v-slot="{ field }"
                                  >
                                    <Multiselect
          ...
          <div class="row mb-2">
            <div class="col-md-6">
              ...
              <Field
                                    name="ethnieCon"
                                    v-model="personnel.conjoints.ethnieCon"
                                    type="text"
                                    v-slot="{ field }"
                                  >
                                    <Multiselect
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control" v-model="personnel.conjoints.telephoneCon">
            </div>
          </div>
            <button type="submit" class="btn btn-primary">Sauvegarder</button>
          </form>
  ...
  <form @submit.prevent="saveHealthInfo">
    <div class="row mb-2">
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" v-model="personnel.santeemploye.taille">
      </div>
      <div class="col-md-6">
        ...
        <template v-if="modalType === 'bank'">
          <form @submit.prevent="saveBankInfo">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" v-model="personnel.numeroCompte">
            </div>
            <div class="mb-3">
              <label class="form-label">Code Iban</label>
              <input type="text" class="form-control" v-model="personnel.compteIban">
            </div>
            <div class="mb-3">
              <label class="form-label">Code swift</label>
              <input type="text" class="form-control" v-model="personnel.Compteswift">
            </div>
            <button type="submit" class="btn btn-primary">Sauvegarder</button>
          </form>
        </template>
...
const openModal = (type) => {
  ...
  try {
    const response = await ApiService.put(`/personnels/${personnel.value.id}`, {
      ...
      telephonePersonneAContacter: personnel.value.telephonePersonneAContacter,
