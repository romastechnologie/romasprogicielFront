...
export default defineComponent({
  ...
  setup(){
    ...
    const handlePaginate = ({ page_, limit_ }) => {
     ...
     function rechercher(){
      getAllFactures(page.value, limit.value, searchTerm.value );
    }
    ...
    function getAllFactures(page = 1, limi = 10, searchTerm = '') {
