                                            ...
                                            <div>
                                              ...
                                              <div class="row" v-for="(mouvement, index) in mouvements" :key="index">
                                                ...
                                                <div class="col-md-2 mb-2">
                                                  <div class="form-group ">
                                                    <Field name="type" v-model="mouvement.type" type="text" v-slot="{ field }">
...
export default defineComponent({
  ...
  setup: () => {
    ...
    watch(
      ...
      (newValue) => {
        ...
        newValue.some(
          ...
          valideteRowMouvement(mouvement.type) ||
    ...
    const addMouvement = async (values, {resetForm}) => {
      ApiService.post("/mouvements",values)
        .then(({ data }) => {
          if(data.code == 201) { 
